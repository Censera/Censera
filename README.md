Learning low-level programming and OS concepts. Focused on [C](https://en.wikipedia.org/wiki/C_(programming_language)), [NixOs](https://en.wikipedia.org/wiki/NixOS).
